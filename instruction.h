...
class Instruction {
  ...
  public:
    ...
    inline void setCond(bool _cond) { cond = _cond; }
    inline bool getCond() { return cond; }
    inline bool getDecodeCycle() { return decodeCycle;}
    inline void setDecodeCycle(int _decodeCycle) { decodeCycle = _decodeCycle;}
